...
#include "OWNVerbMessageHelpers.h"

FString FOWNVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FOWNVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
	return HumanReadableMessage;
}


APlayerState* UOWNVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UOWNVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
...
FGameplayCueParameters UOWNVerbMessageHelpers::VerbMessageToCueParameters(const FOWNVerbMessage& Message)
{
...
FOWNVerbMessage UOWNVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FOWNVerbMessage Result;
